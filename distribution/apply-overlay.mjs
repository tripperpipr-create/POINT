...
for (const name of ['extension.js', 'extension-utils.js', 'backup-controller.js', 'run-config-utils.js', 'ide-navigation-utils.js', 'companion-controller.js', 'companion-chat-controller.js', 'hub-runtime-controller.js', 'infra-controller.js', 'ide-action-controller.js', 'ide-navigation-controller.js', 'connection-controller.js', 'point-panels.js', 'roster-controller.js', 'learning-controller.js', 'tooling-controller.js', 'cursor-controller.js', 'master-chat-controller.js', 'master-turn-stream.js', 'master-work-order-watch.js', 'master-context-controller.js', 'project-registry.js', 'core-warm-pool.js', 'ssh-utils.js', 'cursor-runtime.js', 'core-stream.js', 'chat-documents.js', 'package.json', 'package-lock.json', 'README.md', 'CHANGELOG.md', 'LICENSE', '.vscodeignore', 'dist', 'media', 'themes', 'walkthrough', 'bin']) {
