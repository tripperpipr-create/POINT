...
func BuiltInToolCatalog() []ToolCatalogItem {
	return []ToolCatalogItem{
		...
		{Name: "request_subagent", DisplayName: "Запросить субагента", Description: "Создаёт временного узкого специалиста под активным общим агентом в пределах разрешения и бюджета квеста.", Category: "team", Risk: "MEDIUM"},
