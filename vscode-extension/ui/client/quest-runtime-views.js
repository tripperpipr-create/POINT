export function createQuestRuntimeViews(dependencies) {
  ...
  const CORE_FAILURE_HINTS = [
    ...
    [/daily hub budget exceeded/i, 'Дневной лимит расходов исчерпан. Новые запуски остановлены, пока лимит не обновится или не будет снят жёсткий стоп.'],
    [/monthly hub budget exceeded/i, 'Месячный лимит расходов исчерпан. Новые запуски остановлены, пока лимит не обновится или не будет снят жёсткий стоп.'],
